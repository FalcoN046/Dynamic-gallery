...
<div class="row">
    <div class="col-md-12 head">
        ...
        <div class="float-right">
            <a href="addEdit.php" class="btn btn-success"><i class="plus"></i> New Image</a><br><br>
        </div>
    </div>
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="<?php echo 'uploads/images/'.$row['file_name']; ?>" alt="" style="width: 100%"/></td>
